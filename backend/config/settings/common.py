...
SECRET_KEY = os.environ.get(
    "SECRET_KEY",
    default="django-insecure-v6$@j@0-cvje+wg-)g*!0dm!tfdghf^&%3dfg%+f&5nn^fi0",
)
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(
        minutes=int(os.environ.get("ACCESS_TOKEN_EXPIRE", 30))
    ),
    "REFRESH_TOKEN_LIFETIME": timedelta(
        days=int(os.environ.get("REFRESH_TOKEN_EXPIRE", 7))
    ),
